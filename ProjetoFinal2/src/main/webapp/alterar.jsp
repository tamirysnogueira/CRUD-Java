        ...
        <section id="form">
            ...
            <div id="containerInputsText">
            		<div>
                        ...
                        <input type="text" name="id" id="id" value="<%=idpassagemCliente %>" required maxlength="45" class="input">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" id="name" value="<%=nome %>" required maxlength="45" class="input">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" value="<%=email %>" required class="input" >
                    ...
                    <div>
                        ...
                        <input type="text" name="cpf" id="cpf" required value="<%=cpf %>" maxlength="11" class="input">
                    ...
                    <div>
                        ...
                        <input type="text" id="tel" name="telefone" value="<%=telefone %>" required maxlength="25" class="input">
                    ...
                    <div>
                        ...
                        <input type="date" name="data" id="data" class="input" value="<%=data %>" >
                    ...
                    <div>
                        ...
                        <input type="text" name="local" id="local" class="input" value="<%=telefone %>" >
                    ...
                    <div>
                        ...
                        <input type="number" name="valor" id="valor" class="input" step=".1" value="<%=valorPassagem %>">
            ...
            <input type="submit" name="btnOperacao" value="Alterar" id="alterar" />  
